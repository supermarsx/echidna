...
public final class EffectConfigMergerFixtureTest {
    ...
    private static void rejectsMalformedAmbiguousDuplicateAndConflictingInputs() {
        rejects(() -> EffectConfigMerger.merge(
                "<audio_effects_conf><libraries></audio_effects_conf>",
                EffectConfigMerger.Format.XML,
                null));
        rejects(() -> EffectConfigMerger.merge(
                "<!DOCTYPE x [<!ENTITY e SYSTEM \"file:///data/secret\">]>"
                        + "<audio_effects_conf><libraries/><effects/></audio_effects_conf>",
                EffectConfigMerger.Format.XML,
                null));
        rejects(() -> EffectConfigMerger.merge(
                "<audio_effects_conf><libraries/><libraries/><effects/>"
                        + "</audio_effects_conf>",
                EffectConfigMerger.Format.XML,
                null));
        rejects(() -> EffectConfigMerger.merge(
                "<audio_effects_conf><libraries><library name=\"echidna_preproc\" "
                        + "path=\"wrong.so\"/></libraries><effects/></audio_effects_conf>",
                EffectConfigMerger.Format.XML,
                null));
        rejects(() -> EffectConfigMerger.merge(
                "<audio_effects_conf><libraries/><effects/>"
