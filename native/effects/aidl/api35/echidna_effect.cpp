...
namespace aidl::android::hardware::audio::effect
{
    ...
    public:
            ...
            REQUIRES(mImplMutex) override
        {
            ...
            const int32_t status =
                context_->runtime().SetPacketV2(extension->bytes);
            ...
            REQUIRES(mImplMutex) override
        {
            ...
            const int32_t status = context_->runtime().GetPacketV2(
    ...
    protected:
        ndk::ScopedAStatus commandImpl(CommandId command)
            REQUIRES(mImplMutex) override
        {
            if (!context_)
            {
    ...
    private:
        std::shared_ptr<EchidnaContext> context_ GUARDED_BY(mImplMutex);
    };
