...
namespace echidna
{
    namespace hooks
    {
        ...
        private:
            ...
            /** Attempt a single hook manager, recording the outcome in telemetry.
             * Returns true if the manager installed at least one hook. */
            bool attempt(HookManager &manager);
