...
namespace echidna
{
    namespace hooks
    {
        ...
        private:
            // CaptureContext is defined in the .cpp's anonymous namespace (the only
            // scope that uses it); no nested forward-declaration here, otherwise the
            // member replacements would resolve to this incomplete nested type.
